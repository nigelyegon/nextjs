...
async function POST(req) {
    try {
        ...
        const normalizedEmail = email.trim().toLowerCase();
        const [rows] = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].query("SELECT * FROM users WHERE email = ?", [
            normalizedEmail
        ]);
        if (!rows.length) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (!isMatch) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Invalid credentials"
        }, {
            status: 401
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a328a009._.js.map